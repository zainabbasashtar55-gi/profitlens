...
<?php $__env->startSection('content'); ?>
    <div class="max-w-xl mx-auto bg-white rounded-lg border border-slate-200 p-8">
        ...
        <form method="POST" action="<?php echo e(route('signup')); ?>" class="mt-6 space-y-5">
            <?php echo csrf_field(); ?>
            ...
            <fieldset class="space-y-4">
                ...
                <div>
                    ...
                    <input name="name" type="text" required value="<?php echo e(old('name')); ?>" placeholder="Acme, Inc."
                ...
                <div>
                    ...
                    <div class="flex rounded-md border border-slate-300 overflow-hidden focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
                        <input name="subdomain" type="text" required value="<?php echo e(old('subdomain')); ?>" placeholder="acme"
                ...
                <div>
                    ...
                    <?php $selectedPlan = old('plan', $prefillPlan ?? 'free'); ?>
                    <select name="plan" class="w-full rounded-md border border-slate-300 px-3 py-2 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                        <option value="free"       <?php echo e($selectedPlan === 'free' ? 'selected' : ''); ?>>Free — $0/mo · 3 users, 100 sales/mo</option>
                        <option value="pro"        <?php echo e($selectedPlan === 'pro' ? 'selected' : ''); ?>>Pro — $29/mo · 25 users, 10K sales/mo</option>
                        <option value="enterprise" <?php echo e($selectedPlan === 'enterprise' ? 'selected' : ''); ?>>Enterprise — Talk to sales</option>
                    </select>
                    <?php if(! config('cashier.key') && in_array($selectedPlan, ['pro', 'enterprise'])): ?>
            ...
            <fieldset class="space-y-4 pt-4 border-t border-slate-200">
                ...
                <div>
                    ...
                    <input name="owner_name" type="text" required value="<?php echo e(old('owner_name')); ?>" placeholder="Jane Doe"
                           class="w-full rounded-md border border-slate-300 px-3 py-2 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                </div>

                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Email</label>
                    <input name="owner_email" type="email" required value="<?php echo e(old('owner_email')); ?>" placeholder="jane@acme.com"
                           class="w-full rounded-md border border-slate-300 px-3 py-2 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                </div>
            ...
            <p class="text-xs text-slate-500 text-center">
                Already have a workspace? Visit <code class="bg-slate-100 px-1 rounded">yourcompany.<?php echo e(config('app.tenant_domain')); ?></code> to log in.
            </p>
        </form>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.central', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\profitlens\resources\views/central/signup.blade.php ENDPATH**/ ?>